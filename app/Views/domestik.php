...
<div class="judul">Kategori Kucing Domestik</div>
...
<div class="list-kucing">
    <?php $domestik = array_reverse($domestik); // Membalikkan urutan array posts ?>
    <?php foreach ($domestik as $domestik): ?>
    <a href="/detailkucingdomestik/<?php echo $domestik['id']; ?>" class="kucing-item">
        ...
        <div class="details">
            ...
            <div class="price-address">
                <div class="price">Rp. <?php echo $domestik['harga']; ?></div>
