...
<div class="judul">Kategori Kucing Persia</div>
...
<div class="list-kucing">
    <?php $persia = array_reverse($persia); // Membalikkan urutan array posts ?>
    <?php foreach ($persia as $persia): ?>
    <a href="/detailkucingpersia/<?php echo $persia['id']; ?>" class="kucing-item">
        ...
        <div class="details">
            ...
            <div class="price-address">
                <div class="price">Rp. <?php echo $persia['harga']; ?></div>
