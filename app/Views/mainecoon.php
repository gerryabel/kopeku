...
<link href="https://fonts.googleapis.com/css2?family=Varela+Round&display=swap" rel="stylesheet">
    <title>Kategori Maine Coon</title>
...
<div class="judul">Kategori Kucing Maine Coon</div>
...
<div class="list-kucing">
    <?php $mainecoon = array_reverse($mainecoon); // Membalikkan urutan array posts ?>
    <?php foreach ($mainecoon as $mainecoon): ?>
    <a href="/detailkucingmainecoon/<?php echo $mainecoon['id']; ?>" class="kucing-item">
        <img src="/uploads/<?php echo $mainecoon['gambar']; ?>" alt="<?php echo $mainecoon['nama']; ?>">
        <div class="details">
            <div class="name"><?php echo $mainecoon['nama']; ?></div>
            <div class="ready">Siap Diadopsi</div>
            <div class="price-address">
                <div class="price">Rp. <?php echo $mainecoon['harga']; ?></div>
                <div class="address"><?php echo $mainecoon['lokasi']; ?></div>
            </div>
            <div class="description"><?php echo $mainecoon['deskripsi']; ?></div>
        </div>
    </a>
    <?php endforeach; ?>
</div>
