...
<div class="list-kucing">
    <div class="kucing-item">
        <div class="details">
            <div class="name"><?php echo $domestik['nama']; ?></div>
            <div class="ready">Siap Diadopsi</div>
            <div class="price-address">
                <div class="price">Rp. <?php echo number_format($domestik['harga'], 0, ',', '.'); ?></div>
                <div class="address"><?php echo $domestik['lokasi']; ?></div>
            </div>
            <div class="description"><?php echo $domestik['deskripsi']; ?></div>
            <div class="buttons">
                <a href="<?php echo $domestik['alamat_google_maps']; ?>" target="_blank" class="location-button">Alamat Lengkap</a>
                <a href="https://api.whatsapp.com/send?phone=<?php echo $domestik['nomor_whatsapp']; ?>" target="_blank" class="whatsapp-button">Chat dengan pemilik</a>
            </div>
        </div>
        <img src="/uploads/<?php echo $domestik['gambar']; ?>" alt="<?php echo $domestik['nama']; ?>">
    </div>
</div>
