    ...
    <div class="kucing-item">
        <div class="details">
            ...
            <div class="price-address">
                <div class="price">Rp. <?php echo number_format($sphynx['harga'], 0, ',', '.'); ?></div>
                <div class="address"><?php echo $sphynx['lokasi']; ?></div>
            </div>
            <div class="description"><?php echo $sphynx['deskripsi']; ?></div>
            <div class="buttons">
                <a href="<?php echo $sphynx['alamat_google_maps']; ?>" target="_blank" class="location-button">Alamat Lengkap</a>
                <a href="https://api.whatsapp.com/send?phone=<?php echo $sphynx['nomor_whatsapp']; ?>" target="_blank" class="whatsapp-button">Chat dengan pemilik</a>
            </div>
        </div>
