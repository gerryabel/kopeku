    ...
    <div class="kucing-item">
        <div class="details">
            ...
            <div class="price-address">
                <div class="price">Rp. <?php echo number_format($mainecoon['harga'], 0, ',', '.'); ?></div>
                <div class="address"><?php echo $mainecoon['lokasi']; ?></div>
            </div>
            <div class="description"><?php echo $mainecoon['deskripsi']; ?></div>
            <div class="buttons">
                <a href="<?php echo $mainecoon['alamat_google_maps']; ?>" target="_blank" class="location-button">Alamat Lengkap</a>
                <a href="https://api.whatsapp.com/send?phone=<?php echo $mainecoon['nomor_whatsapp']; ?>" target="_blank" class="whatsapp-button">Chat dengan pemilik</a>
            </div>
        </div>
