...
<div class="judul">Kategori Kucing Anggora</div>
...
<div class="list-kucing">
    <?php $anggora = array_reverse($anggora); // Membalikkan urutan array posts ?>
    <?php foreach ($anggora as $anggora): ?>
    <a href="/detailkucinganggora/<?php echo $anggora['id']; ?>" class="kucing-item">
        ...
        <div class="details">
            ...
            <div class="price-address">
                <div class="price">Rp. <?php echo $anggora['harga']; ?></div>
