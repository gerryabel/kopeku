...
@section('content')
<div>
    {{-- Navbar tambahan untuk forum --}}
    <nav class="bg-white shadow-md rounded-xl py-3 px-4 flex items-center justify-between space-x-6">
        {{-- Logo / Judul --}}
        <div class="font-bold text-xl text-[#578E7E]">
            KOPEKU Forum
        </div>

        {{-- Search form tengah --}}
        <form action="{{ route('forum.index') }}" method="GET" class="flex-grow max-w-lg">
