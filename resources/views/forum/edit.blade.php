...
<div class="max-w-2xl mx-auto bg-white border border-gray-200 rounded-xl shadow p-8 mt-6">
  <h1 class="text-2xl font-bold text-[#578E7E] mb-6">Edit Forum</h1>

  <form action="{{ route('forum.update', $forum) }}" method="POST" enctype="multipart/form-data" class="space-y-5">
    @csrf
    @method('PUT')
    ...
    <div>
      ...
      <div class="grid grid-cols-3 gap-4">
        ...
        <div class="relative group bg-gray-50 rounded-lg overflow-hidden border">
          ...
          {{-- Checkbox hapus --}}
          <label class="absolute top-1 right-1 bg-white bg-opacity-80 p-1 rounded shadow text-xs text-red-600 font-medium">
