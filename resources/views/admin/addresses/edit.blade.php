...
@section('title', 'Edit Kota Kucing')

@section('content')
    <h1 class="text-2xl font-semibold mb-6">Edit Kota Kucing</h1>

    <form method="POST" action="{{ route('admin.addresses.update', $address) }}" class="bg-white rounded p-6 shadow max-w-xl">
        @csrf
        @method('PUT')
