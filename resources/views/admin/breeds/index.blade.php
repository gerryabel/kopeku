...
@section('title', 'Kelola Breed Kucing')
...
<div class="max-w-7xl mx-auto p-6 bg-white rounded-xl shadow-md">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between mb-6 gap-4">
        <div class="flex-1 text-left">
            <h1 class="text-2xl font-semibold">Kelola Jenis Kucing</h1>
        </div>

        <div class="flex-1 max-w-md mx-auto">
            <form action="{{ route('admin.breeds.index') }}" method="GET" class="flex-grow max-w-lg">
    ...
    <table class="w-full border border-gray-300 rounded overflow-hidden text-left">
        <thead class="bg-sage text-white">
            <tr>
                <th class="px-4 py-2">Nama Jenis Kucing</th>
        ...
        <tbody>
            @forelse($breeds as $breed)
                <tr class="border-t border-gray-200">
                    ...
                    <td class="px-4 py-2 flex gap-2">
                        <a href="{{ route('admin.breeds.edit', $breed) }}" class="text-blue-600 hover:underline">Edit</a>
            ...
            @empty
                <tr>
                    <td colspan="2" class="text-center py-4 text-gray-500">Tidak ada data jenis kucing.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
