...
<div class="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-md mt-10">
    <h1 class="text-2xl font-semibold text-[#578E7E] mb-4">Tambah Artikel</h1>
    ...
    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <button type="submit" class="bg-[#578E7E] text-white px-4 py-2 rounded hover:bg-[#476e63]">Simpan</button>
