...
<div class="container max-w-5xl mx-auto p-6 bg-white rounded-xl shadow-lg">
    ...
    <form action="{{ route('catsubmission.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="gender"
                        ...
                        <option value="male" @if(old('gender')=='male' ) selected @endif>Jantan</option>
                        <option value="female" @if(old('gender')=='female' ) selected @endif>Betina</option>
                    </select>
                ...
                <div>
                    ...
                    <textarea name="description" rows="4"
                        class="w-full border rounded px-3 py-2 bg-white focus:ring-[#578E7E]">{{ old('description') }}</textarea>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" name="owner_contact" value="{{ old('owner_contact') }}"
                        class="w-full border rounded px-3 py-2 bg-white focus:ring-[#578E7E]">
                    ...
                    @error('owner_address') <p class="text-red-500 text-sm mt-1">{{ $message }}</p> @enderror
                ...
                <div>
                    <label class="block text-[#3D3D3D]">Upload Gambar</label>
                    <div id="drop-area"
